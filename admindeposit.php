...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    $d1=date('Y/m/d');
    // echo $value1." ".$value2;
    $sqlvar = "insert into tranTab values($nvar,'$d1','$value1','$value2',0,'$value3')";
    $result = $con->query($sqlvar);
    // echo $sqlvar;
    if($result){
        $res="Record Inserted";
    ...
    <div class="container">
        ...
        <form name=form1 method="post" action="admindeposit.php">
            <table class=center width=60% border=1 bgcolor=#ffddaa>
                <br>
                <tr><td colspan=2>Deposit Entry</td></td></td></tr>
                <tr><td>Account No</td><td><input type=text name=text1></td></td></tr>
